...
import 'package:example_buttons/extension/date_utils_extension.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        ...
        // TODO: MODIFY THE TOP THING HERE
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void initState() {
    ...
    firstDayOfWeek = firstWeekDate(firstDayOfWeek);

    print('CURRENDATE: ${widget.currentDate}');
  ...
  void _handleMonthPageChanged(int weekPage) {
    setState(() {
      final DateTime monthDate =
          DateUtils.addMonthsToMonthDate(widget.firstDate, weekPage);
  ...
  Widget _buildItems(BuildContext context, int index) {
    final DateTime month = DateUtils.addDaysToDate(firstDayOfWeek, 7 * index);
  ...
  Widget build(BuildContext context) {
    ...
    final months = DateUtils.monthDelta(widget.firstDate, widget.lastDate);
